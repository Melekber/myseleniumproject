...
//        cookiesAcceptBtn.click();
    ...
    // 4 .Create a method printallTest print all dropdown
    @Test
    ...
    public void printFirstSelectedOptionsTest (){
        WebElement dropDown = driver.findElement(By.id("dropdown"));
        Select select = new Select(dropDown); // Creating an object from Select Class
       WebElement firstOption = select.getFirstSelectedOption();
      String firstText = firstOption.getText();
        System.out.println("firstText " + firstText);

        Assert.assertEquals("Please select an option",firstText);
